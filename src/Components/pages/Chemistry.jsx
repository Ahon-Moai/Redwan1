...
const Chemistry = () => {
  return (
    <>
      <div className="bg-[#001D3D] w-[450px] sm:w-full font-Inter text-white sm:h-[3100px]  h-[4000px] ">
        <main>
          <div
            id="head-div"
            className=" shadow-2xl absolute top-[5%] left-[12%] sm:left-[14%] font-Poppins font-extrabold"
          >
            <h1
        ...
        <section>
          <div className="absolute top-[0%] sm:top-[50%]  sm:left-[27%]">
            <ReactPlayer
              id="player"
              className=""
              controls={true}
